...
/**
 * Commuter registration — "Join the Pulse".
 * Fields: full name, phone number (NG), password.
 * Options: Create Account CTA, Google OAuth, Log in link.
 */
  ...
  return (
    <main className="min-h-screen bg-[#F5F5F0] flex flex-col items-center px-6 pt-14 pb-12 gap-7">
      ...
      <div className="flex flex-col gap-2 text-center w-full">
        <h1 className="text-2xl font-bold text-gray-900">Join the Pulse</h1>
        <p className="text-sm text-gray-500">Start your journey with real-time transit data.</p>
      </div>
      ...
      <p className="text-sm text-gray-500 text-center mt-auto">
        ...
        <button
          ...
          className="text-[#00C9A7] font-semibold underline underline-offset-2"
        >
          Log in
        </button>
      </p>
